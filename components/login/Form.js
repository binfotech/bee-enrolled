...
class LoginFormContainer extends React.Component{
    ...
    submit = async() => {
        try{
            ...
            this.setState({submitting:false,email:'',password:'',remember_me:''});
    ...
    render() {
        return (
            <SigninForm onSubmit={this.onSubmit}>
                ...
                <BottomWrap>
                    <label>
                        <input type="checkbox" name='remember_me' onChange={this.onChange} value="1"/>
                        <span>Remember Me</span>
                    </label>
                    <a href={`${c.BASE_URL}/forgot`}>Forgot Password?</a>
                </BottomWrap>
